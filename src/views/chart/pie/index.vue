              ...
              <el-collapse-item title="数据项配置" name="7">
                ...
                <!-- <div class="series_data_item" v-for="(item, index) in series" :key="index">
                  <el-form-item label="数据"> 
                    <div>{{item.data}}</div>
                    <el-button-group>
                      <el-button type="primary" size="mini" icon="el-icon-minus" @click="updateDataItem(item.data)"></el-button>
                      <el-button type="primary" size="mini" icon="el-icon-plus" @click="updateDataItem(item.data, 1)"></el-button>
                    </el-button-group> 
                  </el-form-item>
